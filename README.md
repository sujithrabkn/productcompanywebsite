...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/ex07/productcompanywebsite/companywebsite/static/css/layout.css">
    <style>
    .text{
        color:blueviolet;
        ...
        <div class="home">
            <div class="header">
                ...
                <center>
                    ...
                    <img src="/static/pics/pic2.png">
                    <img src="/static/pics/pic3.png">
                    <img src="/static/pics/pic4.png">
                    <img src="/static/pics/pic5.png">
                    <img src="/static/pics/pic6.png">
                    <img src="/static/pics/pic7.png">
                </center>
                </div>
                <div class="footer">
                <footer style="color:rgb(206, 50, 50)">
                Copyright &copy;2023 Developed by Sujithra</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ph1{
            background-image: url(/ex07/productcompanywebsite/companywebsite/static/img/item1.png);
        ...
        .ph2{
            background-image: url(/ex07/productcompanywebsite/companywebsite/static/img/item2.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph3{
            background-image: url(//ex07/productcompanywebsite/companywebsite/static/img/item3.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph4{
            background-image: url(/ex07/productcompanywebsite/companywebsite/static/img/item4.png);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        .ph5{
            background-image: url(/img/item5);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        .ph6{
            background-image: url(/ex07/productcompanywebsite/companywebsite/static/img/item6.png);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Vidhya</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Nivetha</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Dhivya</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Swetha</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Sujithra</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Thilagavathi</h2></b></p></div><br>
